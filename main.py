...
for filepath in filepaths:
    ...
    invoice_name = Path(filepath).stem.split("-")
    invoice_nr = f'Invoice nr. {invoice_name[0]}'
    invoice_date = f'Date {invoice_name[1]}'
    ...
    #invoice_pdf.output(f'{filepath[9:].replace(".xlsx", ".pdf")}')